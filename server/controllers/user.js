...
export const signin = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ email: existingUser.email, id: existingUser._id }, 'secrethehe', { expiresIn: "1h" })
...
export const signup = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ email: result.email, id: result._id }, 'secrethehe', { expiresIn: "1h" })
